...
// use Druapl\Core\StringTranslation\StringTranslationInterface;
 ...
 *   description = @Translation("Dose for Custom Field Type"),
 *   category = @Translation("Text"),
 *   default_widget = "fieldapi_field_widget", 
 * )
 */

class FieldAPIFieldType extends FieldItemBase {
  ...
  public function storageSettingsForm(array &$form, FormStateInterface $form_state, $has_data)
  {
    ...
    $element['length'] = [
      '#type' => 'number',
      '#title' => $this->t('Length of your text'),
      '#required' => TRUE,
  ...
  {
    $properties['value'] = DataDefinition::create('string')->setLabel('Name');
